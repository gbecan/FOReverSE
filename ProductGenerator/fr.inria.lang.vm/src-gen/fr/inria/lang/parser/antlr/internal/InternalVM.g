...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getImportDeclarationsImportDeclarationParserRuleCall_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getMetainformationMetaDataParserRuleCall_2_0()); 
	    }
		lv_metainformation_2_0=ruleMetaData		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getVmVariabilityModelParserRuleCall_3_0()); 
	    }
		lv_vm_3_0=ruleVariabilityModel		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getObjectivesObjectivesParserRuleCall_4_0()); 
	    }
		lv_objectives_4_0=ruleObjectives		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getConfigurationsConfigurationsParserRuleCall_5_0()); 
	    }
		lv_configurations_5_0=ruleConfigurations		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getImportDeclarationAccess().getImportURIQUALIFIEDNAMEParserRuleCall_1_0()); 
	    }
...
((	otherlv_0='@name' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMetaDataAccess().getNameKeyword_0_0());
    }
(
(
		lv_name_1_0=RULE_STRING
		{
			newLeafNode(lv_name_1_0, grammarAccess.getMetaDataAccess().getNameSTRINGTerminalRuleCall_0_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMetaDataAccess().getVersionKeyword_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMetaDataAccess().getVersionVersionParserRuleCall_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getMetaDataAccess().getDescriptionKeyword_2_0());
    }
(
(
		lv_description_5_0=RULE_STRING
		{
			newLeafNode(lv_description_5_0, grammarAccess.getMetaDataAccess().getDescriptionSTRINGTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataRule());
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getMetaDataAccess().getAuthorKeyword_3_0());
    }
(
(
		lv_author_7_0=RULE_STRING
		{
			newLeafNode(lv_author_7_0, grammarAccess.getMetaDataAccess().getAuthorSTRINGTerminalRuleCall_3_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataRule());
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getMetaDataAccess().getEmailKeyword_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMetaDataAccess().getEmailEmailParserRuleCall_4_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_10, grammarAccess.getMetaDataAccess().getOrganizationKeyword_5_0());
    }
(
(
		lv_organization_11_0=RULE_STRING
		{
			newLeafNode(lv_organization_11_0, grammarAccess.getMetaDataAccess().getOrganizationSTRINGTerminalRuleCall_5_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataRule());
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getMetaDataAccess().getPublicationKeyword_6_0());
    }
(
(
		lv_publication_13_0=RULE_STRING
		{
			newLeafNode(lv_publication_13_0, grammarAccess.getMetaDataAccess().getPublicationSTRINGTerminalRuleCall_6_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataRule());
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getMetaDataAccess().getDateKeyword_7_0());
    }
(
(
		lv_date_15_0=RULE_STRING
		{
			newLeafNode(lv_date_15_0, grammarAccess.getMetaDataAccess().getDateSTRINGTerminalRuleCall_7_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataRule());
...
// Entry rule entryRuleVariabilityModel
entryRuleVariabilityModel returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getVariabilityModelRule()); }
	 iv_ruleVariabilityModel=ruleVariabilityModel 
	 { $current=$iv_ruleVariabilityModel.current; } 
	 EOF 
;

// Rule VariabilityModel
ruleVariabilityModel returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getVariabilityModelAccess().getRelationshipsRelationshipsParserRuleCall_0_0()); 
	    }
		lv_relationships_0_0=ruleRelationships		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVariabilityModelRule());
	        }
       		set(
       			$current, 
       			"relationships",
...
(
		{ 
	        newCompositeNode(grammarAccess.getVariabilityModelAccess().getAttributesAttributesParserRuleCall_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getVariabilityModelAccess().getDescriptionsDescriptionsParserRuleCall_2_0()); 
	    }
		lv_descriptions_2_0=ruleDescriptions		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVariabilityModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getVariabilityModelAccess().getConstraintsConstraintsParserRuleCall_3_0()); 
	    }
...
((
(
		lv_notTranslatable_0_0=	'@NT' 
    {
        newLeafNode(lv_notTranslatable_0_0, grammarAccess.getFeatureAccess().getNotTranslatableNTKeyword_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "notTranslatable", true, "@NT");
	    }
...
(
		lv_runTime_1_0=	'@RT' 
    {
        newLeafNode(lv_runTime_1_0, grammarAccess.getFeatureAccess().getRunTimeRTKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "runTime", true, "@RT");
	    }
...
)?((	otherlv_3='cloneBetween' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getFeatureAccess().getCloneBetweenKeyword_3_0_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureAccess().getMinIntegerParserRuleCall_3_0_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getFeatureAccess().getAndKeyword_3_0_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureAccess().getMaxIntegerParserRuleCall_3_0_3_0()); 
	    }
		lv_max_6_0=ruleInteger		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureRule());
	        }
       		set(
    ...
    |(	otherlv_7='[' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getFeatureAccess().getLeftSquareBracketKeyword_3_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureAccess().getMinIntegerParserRuleCall_3_1_1_0()); 
	    }
		lv_min_8_0=ruleInteger		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getFeatureAccess().getFullStopFullStopKeyword_3_1_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureAccess().getMaxIntegerParserRuleCall_3_1_3_0()); 
	    }
		lv_max_10_0=ruleInteger		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getFeatureAccess().getRightSquareBracketKeyword_3_1_4());
    }
))?(
(
		lv_name_12_0=RULE_ID
		{
			newLeafNode(lv_name_12_0, grammarAccess.getFeatureAccess().getNameIDTerminalRuleCall_4_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getFeatureRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getCardinalityBasedAccess().getMaxIntegerParserRuleCall_0_1_3_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getCardinalityBasedAccess().getRightSquareBracketKeyword_0_1_4());
    }
))	otherlv_9='{' 
    {
    	newLeafNode(otherlv_9, grammarAccess.getCardinalityBasedAccess().getLeftCurlyBracketKeyword_1());
    }
(
(
(
		...
		lv_groupedFeatures_10_1=ruleFeature		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCardinalityBasedRule());
	        }
       		add(
    ...
    |		{ 
		...
		lv_groupedFeatures_10_2=ruleFeatureHierarchy		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCardinalityBasedRule());
	        }
       		add(
...
(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getCardinalityBasedAccess().getRightCurlyBracketKeyword_4());
    }
)
;
...
(
		lv_runTime_1_0=	'@RT' 
    {
        newLeafNode(lv_runTime_1_0, grammarAccess.getAttrDefAccess().getRunTimeRTKeyword_0_1_0_0());
    }
    ...
    |	otherlv_2='@RunTime' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getAttrDefAccess().getRunTimeKeyword_0_1_1());
    }
)?((
(
		lv_notDecidable_3_0=	'@NotDecideable' 
    {
        newLeafNode(lv_notDecidable_3_0, grammarAccess.getAttrDefAccess().getNotDecidableNotDecideableKeyword_0_2_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "notDecidable", true, "@NotDecideable");
	    }
    ...
    |	otherlv_4='@ND' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getAttrDefAccess().getNDKeyword_0_2_1());
    }
)?)((
(
		{ 
		...
		lv_basicAttrDef_5_0=ruleBasicAttrDef		{
	        if ($current==null) {
...
(
		...
		lv_enumAttrDef_6_0=ruleEnumAttrDef		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAttrDefRule());
	        }
       		set(
