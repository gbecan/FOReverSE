...
public class VMSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_AttrDef_NDKeyword_0_2_1_q;
	protected AbstractElementAlias match_AttrDef_RunTimeKeyword_0_1_1_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_AttrDef_NDKeyword_0_2_1_q = new TokenAlias(false, true, grammarAccess.getAttrDefAccess().getNDKeyword_0_2_1());
		match_AttrDef_RunTimeKeyword_0_1_1_q = new TokenAlias(false, true, grammarAccess.getAttrDefAccess().getRunTimeKeyword_0_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_AttrDef_NDKeyword_0_2_1_q.equals(syntax))
				emit_AttrDef_NDKeyword_0_2_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_AttrDef_RunTimeKeyword_0_1_1_q.equals(syntax))
				emit_AttrDef_RunTimeKeyword_0_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_AttributeDescription_AsteriskFullStopKeyword_1_0_q.equals(syntax))
	 ...
	 *     '@ND'?
	 */
	protected void emit_AttrDef_NDKeyword_0_2_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     '@RunTime'?
	 */
	protected void emit_AttrDef_RunTimeKeyword_0_1_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
